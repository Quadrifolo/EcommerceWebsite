...
<head>
	...
	<link rel="icon" href="{{ URL::asset('evolution.png') }}" type="image/x-icon"/>
	...
	<style>
		...
		.navbar { color: #000; color: var(--ai-primary-alt, #000) }
		.navbar a, .navbar a:before, .navbar span, footer a { color: #000 !important; color: var(--ai-primary-alt, #000 s) !important; }
		.content { margin: 0 5% } .catalog-stage-image { margin: 0 -5.55% }
		footer { color: #000; color: var(--ai-primary-alt, #000); background-color: #f8f8f8; background-color: var(--ai-bg-alt, #f8f8f8); }
...
<body class="aimeos">
	...
	<footer class="mt-5 p-5">
		<div class="row">
			<div class="col-md-8">
				<div class="row">
					<div class="col-sm-6 my-4"><h2>{{ __('LEGAL') }}</h2><p><a href="{{ url('terms') }}">{{ __('Terms & Conditions') }}</a></p><!-- <p><a href="{{ url('privacy') }}">{{ __('Privacy Notice') }}</a></p>--></div>
					<div class="col-sm-6 my-4"><h2>{{ __('ABOUT US') }}</h2><p><a href="{{ url('contact')}}">{{ __('Contact us') }}</a></p><p><a href="{{ url('company') }}">{{ __('Company') }}</a></p></div>
				</div>
			</div>
			<div class="col-md-4 my-4">
				<div class="social"><a href="https://www.facebook.com/Zakai.World" class="sm facebook" title="Facebook" rel="noopener"> </a><a href="https://twitter.com/zakaiworld" class="sm twitter" title="Twitter" rel="noopener"></a><a href="https://www.instagram.com/zakai.world/" class="sm instagram" title="Instagram" rel="noopener"></a> <!--<a href="#" class="sm youtube" title="Youtube" rel="noopener"></a></div> -->
				<!--<a class="px-2 py-4 d-inline-block" href="/"><img src="{{ url('pictures/octuple-max.solid.png') }}"alt=""></a>-->
			</div>
		</div>
	</footer>
	<!-- Scripts -->
